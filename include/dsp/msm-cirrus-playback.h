...
/* Payload struct for getting or setting one integer value
   from/to the DSP module */
struct crus_single_data_t {
	int32_t value;
};

/* Payload struct for getting or setting two integer values
   from/to the DSP module */
...
/* Payload struct for getting or setting three integer values
   from/to the DSP module */
...
/* Payload struct for sending an external configuration string
   to the DSP module */
...
/* Payload struct for sending an external tuning transition string
   to the DSP module */
